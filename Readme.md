...
Key Features
    ...
    • Skyline Compatibility: Generates native .csv transition lists ready for import into Skyline MS.
...
pip install pandas PySide6
    ...
    3. Place gslgen_v10.py (Backend), gui_gslgen_v10.py (Frontend) and icon_256.png in the same directory.
...
6. Integration with Skyline MS

This tool uses a File-Based Integration workflow.
